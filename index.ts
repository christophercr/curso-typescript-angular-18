console.log('⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇⏇');
console.log('\t\t  TypeScript Deep Dive: ejercicios');
console.log('⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈⏈');

console.log("--------- Ready to do some TypeScript? ---------");

// Para mantener la consola relativamente limpia
// puedes comentar los ejercicios anteriores a medida que avanzas.
